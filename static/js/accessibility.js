...
(function () {
  ...
  ------------------------------------------------------------------------- */
  /* Seletores de tudo que o plugin do VLibras injeta na página.
     O widget renderiza fora do #vlibras-wrapper em algumas versões, por isso
     limpamos por atributo/classe e não apenas pelo id. */
  const VLIBRAS_SELECTOR =
    "#vlibras-wrapper, [vw], [vw-access-button], [vw-plugin-wrapper], " +
    ".vw-plugin-top-wrapper, .vw-plugin-wrapper, .vw-access-button, div[vp]";
  ...
  function loadVLibras() {
    ...
    // O wrapper é recriado sempre que necessário: ele é removido ao desativar.
    if (!document.getElementById("vlibras-wrapper")) buildVLibrasWrapper();

    if (document.getElementById("vlibras-script")) {
      // Script já baixado: basta reinstanciar o widget no wrapper novo.
      initVLibrasWidget();
      return;
    }
  ...
  function initVLibrasWidget() {
    if (window.VLibras && document.getElementById("vlibras-wrapper")) {
  ...
  function removeVLibras() {
    ...
    document.querySelectorAll(VLIBRAS_SELECTOR).forEach((el) => {
